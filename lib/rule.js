...
const astUtils = {
    isImportAttributeKey: function (node) {
        const { parent } = node;
...
const string2RegExp = require("./string");
...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            recommended: false,
            url: "https://www.npmjs.com/package/@susiandjames/eslint-plugin-id-denylist-regexp"
        },
    ...
    create(context) {
        const denyList = context.options.map(function (option) {
        ...
        function isRestricted(name) {
            return denyList.some(function (deny) {
